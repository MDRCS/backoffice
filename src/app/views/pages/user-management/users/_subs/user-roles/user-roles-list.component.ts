...
1- load & Display user data on pop-up
2- load all clients
3- Display clients on the dropdown and show selected client (client.id === user.client (number))
4- update user.client by changing selected client
4- return the object client


Create :

1- Display the pop-up
2- load all clients and Display them on the dropdown
3- select client (user.client (number) = client.id )  
4- return the object user
*/
